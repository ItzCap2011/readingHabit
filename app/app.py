...
def hello_world():
    ...
    if request_type_str == 'GET':
        ...
        if str(myage) =='' or str(mygender) =='':
            ...
            return render_template('index.html', href2=str(mybag), href3='The suitable reading habit for you (age:'+str(myage)+' ,gender:'+str(mygender)+') is:'+predictions_to_str)
